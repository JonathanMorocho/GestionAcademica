...
class Estudiante(models.Model):
    ...
    PrimerCiclo = MultiSelectField(max_length=1000, max_choices=7, choices=MateriasPrimerCiclo, default=False, blank=True)
    SegundoCiclo = MultiSelectField(max_length=1000, max_choices=7, choices=MateriasSegundoCiclo, default=False, blank=True)
    TercerCiclo = MultiSelectField(max_length=1000, max_choices=7, choices=MateriasTercerCiclo, default=False, blank=True)
    CuartoCiclo = MultiSelectField(max_length=1000, max_choices=7, choices=MateriasCuartoCiclo, default=False, blank=True)
    QuintoCiclo = MultiSelectField(max_length=1000, max_choices=7, choices=MateriasQuintoCiclo, default=False, blank=True)
    ...
    def _str_(self):
        return (self.dni, self.Nombres, self.Apellidos, self.Fecha_Nacimiento, self.Edad, self.sexoM, self.PeriodoAcademico, self.PrimerCiclo, self.SegundoCiclo, self.TercerCiclo, self.CuartoCiclo, self.QuintoCiclo)    
